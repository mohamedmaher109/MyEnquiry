...
namespace MyEnquiry_BussniessLayer.Interface
{
    public interface ICompany
    {
        ...
        dynamic GetStatistics(ModelStateDictionary modelState, ClaimsPrincipal user);
        dynamic GetById(ModelStateDictionary modelState,int Id);
        Task<dynamic> Add(ModelStateDictionary modelState, Companies model);
        Task<dynamic> Edit(ModelStateDictionary modelState, Companies model);
