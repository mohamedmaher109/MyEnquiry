"use strict"; $("#modeSwitcher").on("click", function (e) {
    e.preventDefault(), modeSwitch(), location.reload()
    if ($("img").is('#logo')) {
        $("div").remove('<img src="~/logo/Group 54387.svg"> ');
        $("div").prepend('<img src="~/logo/Group 54394.svg">');
    }
    else {
        $("div").remove('<img src="~/logo/Group 54394.svg">');
        $("div").prepend('<img id="logo" src="~/logo/Group 54387.svg">');
    }
    ...
    function (a) {
        a(".dropdown-menu a.dropdown-toggle").on("click", function (e) {
            return a(this).next().hasClass("show") || a(this).parents(".dropdown-menu").first().find(".show").removeClass("show"), a(this).next(".dropdown-menu").toggleClass("show"), a(this).parents("li.nav-item.dropdown.show").on("hidden.bs.dropdown", function (e) { a(".dropdown-submenu .show").removeClass("show") }), !1
        })
    }(jQuery),
