...
namespace MyEnquiry_DataLayer.Migrations
{
    ...
    [Migration("20220802153109_sdwwqq")]
    partial class sdwwqq
    {
            ...
            modelBuilder.Entity("MyEnquiry_DataLayer.Models.Cases", b =>
                {
                    ...
                    b.HasOne("MyEnquiry_DataLayer.Models.Cases", "Casese")
                        .WithMany()
